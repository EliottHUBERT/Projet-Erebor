...
<body>
    ...
    <form action="/addAcces/valider" method="POST" class="form-example">
        ...
        <div class="text-center">
            ...
            <button type="button" class="btn btn-secondary mx-sm-3 mb-2" style="min-width: 10%" onclick="location.href='/listeDossiers'"><img src="../../../../Images/return.svg" style="width: 25%"></button>
        </div>
