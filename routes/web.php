...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::post('/delDossier',[\App\Http\Controllers\espaceController::class,"delete"]);
    Route::delete('/delDossier/valider',[\App\Http\Controllers\espaceController::class,"do_delete"]);

    Route::post('/editDossier',[\App\Http\Controllers\espaceController::class,"update"]);
    Route::put('/editDossier',[\App\Http\Controllers\DemandeModifEspaceController::class,"add"]);



    //___FICHIERS___
    Route::post("/listeFichiers", [\App\Http\Controllers\fichierController::class, "showall"]);
